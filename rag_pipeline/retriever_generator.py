...
# Add this if not already present in rag_pipeline/retriever_generator.py

def get_model_and_retriever():
    # Update the import statement to use load_quantized_model instead of load_model
    from rag_pipeline.model_loader import load_quantized_model
